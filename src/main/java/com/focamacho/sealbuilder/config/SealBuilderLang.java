...
public class SealBuilderLang implements ILangConfig {
    ...
    public Map<String, LinkedHashMap<String, String>> getDefaultTranslations() {
        ...
        pt_br.put("menu.create.confirm.lore", "&7Isso vai lhe custar &c%price% %currencyname%&7.%blacklistwarn%%discountlore%");
        pt_br.put("menu.create.pokemon.name", "&d%pokemonname%");
        pt_br.put("menu.create.pokemon.lore", "&7Preço: &d&c%price% %currencyname%%blacklistwarn%%discountlore%");
        ...
        pt_br.put("menu.shiny.confirm.lore", "&7Isso vai lhe custar &c%price% %currencyname%&7.%discountlore%");
        pt_br.put("menu.shiny.pokemon.name", "&d%pokemonname%");
        pt_br.put("menu.shiny.pokemon.lore", "&7Preço: &d&c%price% %currencyname%%discountlore%");
        ...
        pt_br.put("menu.gender.confirm.lore", "&7Isso vai lhe custar &c%price% %currencyname%&7.%discountlore%");
        ...
        pt_br.put("menu.hiddenability.confirm.lore", "&7Isso vai lhe custar &c%price% %currencyname%&7.%discountlore%");
