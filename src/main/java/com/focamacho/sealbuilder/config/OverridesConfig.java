...
public class OverridesConfig {
    ...
    public static void initOverrides() throws IOException {
        ...
        File overridesFile = new File(Paths.overridesFile);
        ...
        for(int i = 0; i < array.length(); i++) {
            try {
                ...
                String currency = object.optString("currency", "default");
        ...
        for(int i = 0; i < array.length(); i++) {
            try {
                ...
                if(object.optString("pokemon").equalsIgnoreCase("legendary")) {
                    for (EnumSpecies legendary : EnumSpecies.LEGENDARY_ENUMS) {
                        if (!naturePriceOverrides.containsKey(legendary)) naturePriceOverrides.put(legendary, new ArrayList<>());
                    ...
                    if (specie != null || nature != null) {
                        if (nature != null && specie == null) {
                            ...
                            if (!naturePriceOverrides.containsKey(specie)) naturePriceOverrides.put(specie, new ArrayList<>());
        ...
        for(int i = 0; i < array.length(); i++) {
            try {
                ...
                if(object.optString("pokemon").equalsIgnoreCase("legendary")) {
                    for (EnumSpecies legendary : EnumSpecies.LEGENDARY_ENUMS) {
                        if (!pokeballPriceOverrides.containsKey(legendary)) pokeballPriceOverrides.put(legendary, new ArrayList<>());
        ...
        for(int i = 0; i < array.length(); i++) {
            try {
                ...
                if(object.optString("pokemon").equalsIgnoreCase("legendary")) {
                    for (EnumSpecies legendary : EnumSpecies.LEGENDARY_ENUMS) {
                        if (!growthPriceOverrides.containsKey(legendary)) growthPriceOverrides.put(legendary, new ArrayList<>());
        ...
        for(int i = 0; i < array.length(); i++) {
            try {
                ...
                if(object.optString("pokemon").equalsIgnoreCase("legendary")) {
                    for (EnumSpecies legendary : EnumSpecies.LEGENDARY_ENUMS) {
                        if (!ivsPriceOverrides.containsKey(legendary)) ivsPriceOverrides.put(legendary, new ArrayList<>());
