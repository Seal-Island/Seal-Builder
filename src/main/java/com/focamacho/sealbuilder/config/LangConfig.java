...
public class LangConfig {
    ...
    private static Map<String, String> getDefaultMessages() {
        ...
        //if(PluginConfig.defaultLang.equalsIgnoreCase("pt_BR")) {
            //Menu Principal
        ...
        /*} else {
            //Menu Principal
            defaultMessages.put("menu.main.title", "Click on a Pokémon");
            defaultMessages.put("menu.main.pokemon.name", "&f%pokemonname% &7- &bLevel &d%pokemonlvl%");
            defaultMessages.put("menu.main.pokemon.lore", "&7Ability: &d%pokemonability%\n&7Nature: &d%pokemonnature%\n&7Hidden Power: &d%pokemonhiddenpower%\n&7Gender: &d%pokemongender%\n&7Growth: &d%pokemonsize%\n&7Happiness: &d%pokemonhappiness%\n&7Shiny: &d%pokemonshiny%\n&7Used Ball: &d%pokemonball%\n\n&7IVs: &d%pokemonivsum%&7/&d186 &7(&d%pokemonivpercentage%%&7)\n&cHP: %pokemonivhp% &7/ &eAttack: %pokemonivatk% &7/ &9Defence: %pokemonivdef%\n&bSpeed: %pokemonivspe% &7/ &6Spc. Atk: %pokemonivspa% &7/ &3Spc. Def: %pokemonivspd%\n&7EVs: &d%pokemonevsum%&7/&d510 &7(&d%pokemonevpercentage%%&7)\n&cHP: %pokemonevhp% &7/ &eAttack: %pokemonevatk% &7/ &9Defence: %pokemonevdef%\n&bSpeed: %pokemonevspe% &7/ &6Spc. Atk: %pokemonevspa% &7/ &3Spc. Def: %pokemonevspd%\n\n&7Moves:\n&7- &b%pokemonmoveone%\n&7- &b%pokemonmovetwo%\n&7- &b%pokemonmovethree%\n&7- &b%pokemonmovefour%\n");
            defaultMessages.put("menu.main.create", "&7Click to create a &dPokémon&7.");
            defaultMessages.put("menu.main.nopokemon", "&7Capture a &dPokémon &7first.");

            //Menu de Compra de Pokémon
            defaultMessages.put("menu.create.title", "Buy pokémon");
            defaultMessages.put("menu.create.cancel.name", "&cCancel");
            defaultMessages.put("menu.create.cancel.lore", "&7Close the menu.");
            defaultMessages.put("menu.create.confirm.name", "&aConfirm");
            defaultMessages.put("menu.create.confirm.lore", "&7This will cost you &c%price% %currencyname%&7.%blacklistwarn%%discountlore%");
            defaultMessages.put("menu.create.pokemon.name", "&d%pokemonname%");
            defaultMessages.put("menu.create.pokemon.lore", "&7Price: &d&c%price% %currencyname%%blacklistwarn%%discountlore%");
            defaultMessages.put("menu.create.blacklistwarn", "\n&7Warning! The following modifiers are\n&7blocked on this &dPokémon&7:");

            //Menu de Shiny
            defaultMessages.put("menu.shiny.title", "Toggle shiny");
            defaultMessages.put("menu.shiny.cancel.name", "&cCancel");
            defaultMessages.put("menu.shiny.cancel.lore", "&7Back to the edit menu.");
            defaultMessages.put("menu.shiny.confirm.name", "&aConfirm");
            defaultMessages.put("menu.shiny.confirm.lore", "&7This will cost you &c%price% %currencyname%&7.%discountlore%");
            defaultMessages.put("menu.shiny.pokemon.name", "&d%pokemonname%");
            defaultMessages.put("menu.shiny.pokemon.lore", "&7Price: &d&c%price% %currencyname%%discountlore%");

            //Menu de Mudança de Gênero
            defaultMessages.put("menu.gender.title", "Toggle gender");
            defaultMessages.put("menu.gender.cancel.name", "&cCancel");
            defaultMessages.put("menu.gender.cancel.lore", "&7Back to the edit menu.");
            defaultMessages.put("menu.gender.confirm.name", "&aConfirm");
            defaultMessages.put("menu.gender.confirm.lore", "&7This will cost you &c%price% %currencyname%&7.%discountlore%");
            defaultMessages.put("menu.gender.pokemon.name", "&d%pokemonname%");
            defaultMessages.put("menu.gender.pokemon.lore", "&7New Gender: &d%pokemongender%\n&7Price: &d&c%price% %currencyname%%discountlore%");

            //Menu de Desbloqueio de Habilidade Oculta
            defaultMessages.put("menu.hiddenability.title", "Unlock hidden ability");
            defaultMessages.put("menu.hiddenability.cancel.name", "&cCancel");
            defaultMessages.put("menu.hiddenability.cancel.lore", "&7Back to the edit menu.");
            defaultMessages.put("menu.hiddenability.confirm.name", "&aConfirm");
            defaultMessages.put("menu.hiddenability.confirm.lore", "&7This will cost you &c%price% %currencyname%&7.%discountlore%");
            defaultMessages.put("menu.hiddenability.pokemon.name", "&d%pokemonname%");
            defaultMessages.put("menu.hiddenability.pokemon.lore", "&7New Ability: &d%pokemonability%\n&7Price: &d&c%price% %currencyname%%discountlore%");

            //Menu de Edição de Pokébola
            defaultMessages.put("menu.growth.title", "Choose a new growth");
            defaultMessages.put("menu.growth.lore", "&7Click to choose this &aGrowth&7.\n&7Price: &a%price% %currencyname%%discountlore%");
            defaultMessages.put("menu.growth.your", "&7This is already the current &aGrowth&7.");

            //Menu de Edição de Nature
            defaultMessages.put("menu.nature.title", "Choose a new nature");
            defaultMessages.put("menu.nature.lore", "&a+ %plusstats%\n&c- %minusstats%\n&7Click to choose this &cNature&7.\n&7Price: &a%price% %currencyname%%discountlore%");
            defaultMessages.put("menu.nature.neutral", "&8+- Neutral\n&7Click to choose this &cNature&7.\n&7Price: &a%price% %currencyname%%discountlore%");
            defaultMessages.put("menu.nature.your", "&7This is already the current &cNature&7.");
            defaultMessages.put("menu.nature.attack.plus", "&aAttack Increase");
            defaultMessages.put("menu.nature.defence.plus", "&aDefence Increase");
            defaultMessages.put("menu.nature.spattack.plus", "&aSpecial Attack Increase");
            defaultMessages.put("menu.nature.spdefence.plus", "&aSpecial Defence Increase");
            defaultMessages.put("menu.nature.speed.plus", "&aSpeed Increase");
            defaultMessages.put("menu.nature.attack.minus", "&cAttack Reduction");
            defaultMessages.put("menu.nature.defence.minus", "&cDefence Reduction");
            defaultMessages.put("menu.nature.spattack.minus", "&cSpecial Attack Reduction");
            defaultMessages.put("menu.nature.spdefence.minus", "&cSpecial Defence Reduction");
            defaultMessages.put("menu.nature.speed.minus", "&cSpeed Reduction");

            //Menu de Edição de IVs
            defaultMessages.put("menu.ivs.title", "Set your IVs");
            defaultMessages.put("menu.ivs.hp.plus", "&aIncrease HP");
            defaultMessages.put("menu.ivs.attack.plus", "&aIncrease Attack");
            defaultMessages.put("menu.ivs.defence.plus", "&aIncrease Defence");
            defaultMessages.put("menu.ivs.specialattack.plus", "&aIncrease Special Attack");
            defaultMessages.put("menu.ivs.specialdefence.plus", "&aIncrease Special Defence");
            defaultMessages.put("menu.ivs.speed.plus", "&aIncrease Speed");
            defaultMessages.put("menu.ivs.hp.minus", "&cDecrease HP");
            defaultMessages.put("menu.ivs.attack.minus", "&cDecrease Attack");
            defaultMessages.put("menu.ivs.defence.minus", "&cDecrease Defence");
            defaultMessages.put("menu.ivs.specialattack.minus", "&cDecrease Special Attack");
            defaultMessages.put("menu.ivs.specialdefence.minus", "&cDecrease Special Defence");
            defaultMessages.put("menu.ivs.speed.minus", "&cDecrease Speed");
            defaultMessages.put("menu.ivs.limit.plus", "&7Maximum limit reached.");
            defaultMessages.put("menu.ivs.limit.minus", "&7Minimum limit reached.");
            defaultMessages.put("menu.ivs.lore.plus", "&7Click to increase this &bIV &7by &b1 &7for &a%price% %currencyname%&7.\n&7Shift + Click to increase this &bIV &7by &b10 &7for &a%priceiv10% %currencyname%&7.%discountlore%");
            defaultMessages.put("menu.ivs.lore.minus", "&7Click to decrease this &bIV &7by &b1 &7for &a%price% %currencyname%&7.\n&7Shift + Click to increase this &bIV &7by &b10 &7for &a%priceiv10% %currencyname%&7.%discountlore%");
            defaultMessages.put("menu.ivs.max.name", "&dMaximum &bIVs");
            defaultMessages.put("menu.ivs.max.lore", "&7Click to set all your &dPokémon's &bIVs &7to\n&7the maximum for &a%ivmaxprice% %currencyname%&7.%discountlore%");
            defaultMessages.put("menu.ivs.random.name", "&cRandom &bIVs");
            defaultMessages.put("menu.ivs.random.lore", "&7Click to randomize all your &dPokémon's &bIVs\n&7for &a%price% %currencyname%&7.\n&7(3 Perfect)%discountlore%");

            //Menu de Edição de Pokémon
            defaultMessages.put("menu.edit.title", "Click on something to edit");
            defaultMessages.put("menu.edit.pokeball.name", "&fPoké Ball");
            defaultMessages.put("menu.edit.pokeball.lore", "&7Click to edit the &dPoké Ball\n&7of your &dPokémon.");
            defaultMessages.put("menu.edit.shiny.name", "&eShiny");
            defaultMessages.put("menu.edit.shiny.lore", "&7Click to toggle the &eShiny\n&7of your &dPokémon&7.");
            defaultMessages.put("menu.edit.growth.name", "&aGrowth");
            defaultMessages.put("menu.edit.growth.lore", "&7Click to toggle the &aGrowth\n&7of your &dPokémon&7.");
            defaultMessages.put("menu.edit.hiddenability.name", "&5Hidden Ability");
            defaultMessages.put("menu.edit.hiddenability.lore", "&7Click to unlock the &5Hidden&7\n&5Ability &7of your &dPokémon&7.");
            defaultMessages.put("menu.edit.hiddenability.your", "&7Your &dPokémon &7already has\n&7its &5Hidden Ability&7.");
            defaultMessages.put("menu.edit.hiddenability.none", "&7Your &dPokémon &7don't have\n&7a &5Hidden Ability&7.");
            defaultMessages.put("menu.edit.gender.name", "&dGender");
            defaultMessages.put("menu.edit.gender.lore", "&7Click to toggle the &dGender\n&7of your &dPokémon&7.");
            defaultMessages.put("menu.edit.gender.nogender", "&7This &dPokémon &7only has\n&7one &dGender&7.");
            defaultMessages.put("menu.edit.nature.name", "&cNature");
            defaultMessages.put("menu.edit.nature.lore", "&7Click to change the &cNature\n&7of your &dPokémon&7.");
            defaultMessages.put("menu.edit.ivs.name", "&bIVs");
            defaultMessages.put("menu.edit.ivs.lore", "&7Click to change the &bIVs\n&7of your &dPokémon&7.");

            //Menu de Edição de Pokébola
            defaultMessages.put("menu.pokeball.title", "Choose a new Poké Ball");
            defaultMessages.put("menu.pokeball.lore", "&7Click to choose this &dPoké Ball&7.\n&7Price: &a%price% %currencyname%%discountlore%");
            defaultMessages.put("menu.pokeball.your", "&7This is already the current &dPoké Ball&7.");

            //Mensagens no Chat
            defaultMessages.put("chat.prefix", "&7[&dSeal Builder&7] ");
            defaultMessages.put("chat.nopokemon", "&7Could not find any &dPokémon &7with the given name.");
            defaultMessages.put("chat.money.insufficient", "&7You don't have enough %currencyname% to do this.");
            defaultMessages.put("chat.buy.success", "&7Você adquiriu o &dPokémon &7com sucesso.");
            defaultMessages.put("chat.create", "&7Digite o nome do &dPokémon &7que você deseja.");
            defaultMessages.put("chat.edit.pokeball", "&7Você alterou a &dPokébola &7do seu &dPokémon &7com sucesso.");
            defaultMessages.put("chat.create.blacklist", "&7Desculpe, não é permitido a criação deste tipo de &dPokémon&7.");
            ...
            //Básico
            defaultMessages.put("yes", "Yes");
            defaultMessages.put("no", "No");
            defaultMessages.put("none", "None");

            //Gêneros
            defaultMessages.put("gender.male", "Male");
            defaultMessages.put("gender.female", "Female");
            defaultMessages.put("gender.none", "Genderless");

            //Tamanhos
            defaultMessages.put("growth.microscopic", "Microscopic");
            defaultMessages.put("growth.pygmy", "Pygmy");
            defaultMessages.put("growth.runt", "Runt");
            defaultMessages.put("growth.small", "Small");
            defaultMessages.put("growth.ordinary", "Ordinary");
            defaultMessages.put("growth.huge", "Huge");
            defaultMessages.put("growth.giant", "Giant");
            defaultMessages.put("growth.enormous", "Enormous");
            defaultMessages.put("growth.ginormous", "Ginormous");

            //Status
            defaultMessages.put("statstype.none", "None");
            defaultMessages.put("statstype.hp", "HP");
            defaultMessages.put("statstype.attack", "Attack");
            defaultMessages.put("statstype.defence", "Defence");
            defaultMessages.put("statstype.specialattack", "Special Attack");
            defaultMessages.put("statstype.specialdefence", "Special Defence");
            defaultMessages.put("statstype.speed", "Speed");
            defaultMessages.put("statstype.accuracy", "Accuracy");
            defaultMessages.put("statstype.evasion", "Evasion");

            //Status "Compactados"
            defaultMessages.put("statstype.none.compact", "None");
            defaultMessages.put("statstype.hp.compact", "HP");
            defaultMessages.put("statstype.attack.compact", "Atk.");
            defaultMessages.put("statstype.defence.compact", "Def.");
            defaultMessages.put("statstype.specialattack.compact", "Spc. Atk.");
            defaultMessages.put("statstype.specialdefence.compact", "Spc. Def.");
            defaultMessages.put("statstype.speed.compact", "Spd.");
            defaultMessages.put("statstype.accuracy.compact", "Accr.");
            defaultMessages.put("statstype.evasion.compact", "Evas.");

            //Nomes de Modifier
            defaultMessages.put("modifier.growth", "&cGrowth");
            defaultMessages.put("modifier.shiny", "&cShiny");
            defaultMessages.put("modifier.pokeball", "&cPoké Ball");
            defaultMessages.put("modifier.ivs", "&cIVs");
            defaultMessages.put("modifier.nature", "&cNature");
            defaultMessages.put("modifier.gender", "&cGender");
            defaultMessages.put("modifier.hiddenability", "&cHidden Ability");

            //Outros
            defaultMessages.put("discount.applied", "\n\n&7&oYour %discount% discount has already been applied to the value.");
        }*/
